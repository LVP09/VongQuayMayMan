...
$.widget('javobyte.rouletteWheel', {
    ...
    _create: function () {
        ...
        if (canvas.getContext) {
            ...
            this._options.radius = base * 0.9 / 2;
            this._options.innerRadius = base * 0.6 / 2;
            ...
            this.element.click(function (e) {
		        ...
		        widget.options.start();
                        setTimeout(function() { widget.spin(); }, 200);
                    }
                }
    ...
    _draw: function () {
        ...
        ctx.fillStyle = '#CC0F32';
        ctx.drawImage(this.options.pointer, cx - 25, cy - radius - 45, 50, 50);

        if (!this.is_rotating()) {
            ctx.save();
            ctx.font = 'bold 350px Helvetica, Arial';
               
            var text = this.options.spinText;
            ctx.fillText(text, cx - ctx.measureText(text).width / 2, cy + 100);
            ctx.restore();
        }
    ...
    _rotate: function () {
        this._options.spinTime += 17; //10 = 15s
    ...
    stop: function () {
        ...
        $('#textgg').text(this.options.items[key]);
